...
print("(6/) Point multiplication Tests Passed")
...
print("(7/) Point embedding Tests Passed")
...
print("(8/) Random Point Tests Passed")

temp = (ecf.embedData(2, ecf.CurveField(0, 3, 11)))
print(str(temp[1]) + " " + str(temp[0]))
print(nffa.legendreSymbol(0, 11))
