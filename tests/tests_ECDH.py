...
from EcClairvaux import ECDH as dh
...
aPrivateKey = randint(0, curve.p-1)
aPublicKey = dh.generatePublicKey(aPrivateKey, generator, curve)
bPrivateKey = randint(0, curve.p-1)
bPublicKey = dh.generatePublicKey(bPrivateKey, generator, curve)

#print(dh.computeSharedKey(aPrivateKey, bPublicKey, curve))
#print(dh.computeSharedKey(bPrivateKey, aPublicKey, curve))

assert dh.computeSharedKey(aPrivateKey, bPublicKey, curve) == dh.computeSharedKey(bPrivateKey, aPublicKey, curve)
