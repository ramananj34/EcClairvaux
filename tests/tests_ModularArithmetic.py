#Tests written with the help of chatGPT, so take with a grain of salt
...
print("(1/8) Addition Tests Passed")
...
print("(2/8) Subtraction Tests Passed")
...
print("(3/8) Multiplication Tests Passed")
...
print("(4/8) Negation Tests Passed")
...
print("(5/8) Euclidian Algorithm Tests Passed")
...
print("(6/8) Extended Euclidian Algorithm Tests Passed")
...
print("(7/8) Inverse Tests Passed")
